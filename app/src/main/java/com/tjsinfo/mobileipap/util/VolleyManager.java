...
import com.tjsinfo.mobileipap.App;
...
public class VolleyManager {
     ...
     * @param errorListener
     * @param <T>
     * @return public <T> GsonRequest<T> GsonGetRequest(Object tag, String url, Class<T> clazz, Response.Listener<T> listener,
    Response.ErrorListener errorListener) {
     ...
     * @param errorListener
     * @param <T>
     * @return public <T> GsonRequest<T> GsonPostRequest(Object tag, Map<String, String> params, String url,
    ...
    public <T> JacksonRequest<T> jacksonPostRequest(Object tag, String url, Class<T> clazz, String requestBody, Response.Listener<T> listener, Response.ErrorListener errorListener) {
        JacksonRequest<T> request = new JacksonRequest<T>(Request.Method.POST, url, clazz, requestBody, listener, errorListener);
        request.setTag(tag);
        add(request);
        return request;
    }
